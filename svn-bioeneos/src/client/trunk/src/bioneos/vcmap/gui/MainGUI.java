...
import bioneos.vcmap.mac.Mac15AboutHandler;
import bioneos.vcmap.mac.MacAboutHandler;
  ...
  implements ActionListener, ChangeListener, MenuListener
{
  ...
  public MainGUI(BNApplication app)
  {
    ...
    // Final Macintosh setup
    if (System.getProperty("os.name").toLowerCase().indexOf("mac") != -1)
    {
      if (System.getProperty("java.version").startsWith("1.5"))
      {
        // Need to use the old deprecated methods
        new Mac15AboutHandler(this);
      }
      else
      {
        // New method of handling abouts
        new MacAboutHandler(this);
      }
    }
